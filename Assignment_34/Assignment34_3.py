...
def main():
    Border = "-" * 50
    print(Border)
    print("----- Marvellous Platform Surviliance System -----")
    print(Border)
    ...
    if (len(sys.argv) == 2):
        if(sys.argv[1] == "--h" or sys.argv[1] == "--H"):
            ...
            print("3 : It maintains all records into log files")
            print("4 : It sends the log files through mail periodically")
            ...
            print("Unable to proceed as thier is no matching arguument")
    ...
    # Actual project code
        ...
        schedule.every(int(sys.argv[1])).minutes.do(ProcessInfo, sys.argv[2])
        ...
        print("Usable to proceed as arguments are not matching")
        print("Please use --u or --h flag for getting more details")
